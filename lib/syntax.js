...
import { StreamIterable, getStreamIterator, wait, continue_ } from '@bablr/agast-helpers/iterable';
import { groupTags } from '@bablr/agast-helpers/stream';
...
import { ansiRules, buildOpenNodeTag, printOpenNodeTag } from '@bablr/io-vm';
...
export function writeOutput(tags, options = freezeRecord({})) {
  ...
  return options.compact
    ? writeCSTML(tags, options)
    : writePrettyCSTML(groupTags(tags, options), options);
}
